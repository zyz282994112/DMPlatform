...
public class FieldFilterSelectDs extends HttpServlet implements Servlet {
	public FieldFilterSelectDs() {
	...
	protected void doPost(HttpServletRequest request,
		...
		response.getWriter().write("<script>window.location.href='view/dataset/fieldFilterSelectDs.jsp'</script>");
		return;
		}
		else
		{
