...
public class ManageDataset extends HttpServlet implements Servlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		response.getWriter().write("<script>window.location.href='view/dataset/manageDataset.jsp'</script>");
		return;
		}
		else
		{
