...
public class RecordFilterSelectDs extends HttpServlet implements Servlet {
	public RecordFilterSelectDs() {
	...
	protected void doPost(HttpServletRequest request,
		...
		response.getWriter().write("<script>window.location.href='view/dataset/recordFilterSelectDs.jsp'</script>");
		return;
		}
		else
		{
