 ...
 */
public class ShowRuleServlet extends HttpServlet {

    public String getInputPath(String input) {
        return "/Users/chengsiyuan/IdeaProjects/SPMF/output_rulegrowth.txt";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String output = JavaCallPython.runRuleResultTopK(new String[]{input});
