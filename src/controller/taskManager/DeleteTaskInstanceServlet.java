...
public class DeleteTaskInstanceServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public DeleteTaskInstanceServlet() {
		super();
	}
...
//		int taskID = 21;
		...
		try {
			taskInstanceBean.deleteTaskInstance(TIID);
		...
		System.out.println("DeleteTaskServlet sucess !");
