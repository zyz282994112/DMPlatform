...
<div class="container">
   <div class="panel">
       <ul class="nav nav-tabs">
            ...
            <li class="active"><a href="view/algorithm/queryAlgo.jsp">查询算法</a></li>
            <li><a href="view/algorithm/updateAlgo.jsp">更新算法</a></li>
		</ul>
        <div class="panel-body">  
	        <form class="form-horizontal" action="queryalgorithm" method="get" enctype="multipart/form-data" >
	                    <div class="form-group">
					 	...
					 	<div class="form-group">
						    ...
						    <div class="col-sm-3">
						    	<textarea rows="10" class="form-control" id="Description" type="text" name="algorithmDescription"></textarea>
						    </div>
					 	</div>
	                </form>
