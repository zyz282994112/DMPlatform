...
<h1>Run Task </h1>
  ...
  <div class="panel-body">
        <form class="form-horizontal" role="form" method="post" action="RunTaskInstanceServlet.do">
        	<input id="hashmap" type="text" name="hashmap" style="display:none"/>
        		<div class="form-group">
				    <label for="inputEmail3" class="col-sm-2 control-label">TIName</label>
				    <div class="col-sm-10">
				      <input type="text" class="form-control" name="TIName"  >
				    </div>
				  </div>
        		...
        		<div class="form-group">
				  ...
				  <div class="form-group">
				   ...
				   <div class="form-group">
				    ...
				    <div class="col-sm-10">
				      <input type="text" class="form-control" name="UserID" value=<%=task.getUserID()%>>
				    </div>
				  	</div>			  
				  <div class="form-group">
				   ...
				   <div class="form-group">
				    <label for="inputEmail3" class="col-sm-2 control-label">AlgorithmName</label>
				    <div class="col-sm-10">
				      <input type="text" class="form-control" name="AlgorithmName" value=<%=task.getAlgorithmName()%> >
				    </div>
				  </div>
				   <div class="form-group">
				    <label for="inputEmail3" class="col-sm-2 control-label">TaskResultPath</label>
				    <div class="col-sm-10">
				      <input type="text" class="form-control" name="TaskResultPath" value=<%=task.getTaskResultPath()%> >
				    </div>
				  </div>
				   <div class="form-group">
				    <label for="inputEmail3" class="col-sm-2 control-label">TaskRunNumber</label>
				    <div class="col-sm-10">
				      <input type="text" class="form-control" name="TaskRunNumber" value=<%=task.getTaskRunNumber()%> >
				    </div>
				  </div>
				  
				    <div class="form-group">
				    <label for="inputEmail3" class="col-sm-2 control-label">TIDescription</label>
				    <div class="col-sm-10">
				      <input type="text" class="form-control" name="TIDescription" >
				    </div>
				  </div>
				   <div class="form-group">
					 <label for="inputEmail3" class="col-sm-2 control-label">算法名称</label>
		                <select id="Algorithm_Name" name="algorithmList" onchange="adjustInput11(this.options[this.options.selectedIndex].value)">
